...
class HintsControllerTest < ActionController::TestCase
  ...
  test "should create hint" do
    assert_difference('Hint.count') do
      post :create, hint: { away_goals: @hint.away_goals, game_id: @hint.game_id, home_goals: @hint.home_goals, user_id: @hint.user_id }
    end
  ...
  test "should update hint" do
    put :update, id: @hint, hint: { away_goals: @hint.away_goals, game_id: @hint.game_id, home_goals: @hint.home_goals, user_id: @hint.user_id }
    assert_redirected_to hint_path(assigns(:hint))
  end
